...
// load custom font three
if ($this->params->get('enable_custom_font_three') && $this->params->get('custom_font_three_selectors')) {
    $webfonts = array();
    $webfonts[$this->params->get('custom_font_three_selectors')] = $this->params->get('custom_font_three');
    $theme->addGoogleFont($webfonts);
}
