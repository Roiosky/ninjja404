...
class HelixUltimateFeatureSocial
{
	...
	public function renderFeature()
	{
		...
		if( $this->params->get('show_social_icons') && ( $facebook || $twitter || $pinterest || $youtube || $linkedin || $dribbble || $instagram || $behance || $skype || $flickr || $vk || $custom ) )
		{
			...
			if( $twitter )
			{
				$html .= '<li class="social-icon-twitter"><a target="_blank" href="'. $twitter .'" aria-label="twitter"><span class="fab fa-x-twitter" aria-hidden="true"></span></a></li>';
			}
			...
			if( $youtube )
			{
				$html .= '<li><a target="_blank" href="'. $youtube .'" aria-label="Youtube"><span class="fa fa-youtube-play" aria-hidden="true"></span></a></li>';
			}
