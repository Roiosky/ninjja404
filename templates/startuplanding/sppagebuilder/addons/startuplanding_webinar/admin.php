...
SpAddonsConfig::addonConfig(
	array(
		'type'=>'content',
		'addon_name'=>'sp_startuplanding_webinar',
		'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_STARTUPLANDING_WEBINAR'),
		'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_STARTUPLANDING_WEBINAR_DESC'),
		'category'=>'Startuplanding',
		'attr'=>array(
			'general' => array(
				...
				'modal_content_video_url'=>array(
					...
					'std'=> 'https://www.youtube.com/watch?v=YZcT74ZqkOA'
				),
				...
				// Repeatable Items
				'sp_startuplanding_webinar_user'=>array(
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_STARTUPLANDING_WEBINAR_USERS'),
					'attr'=>array(
						'name'=>array(
							'type'=>'text',
							'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_STARTUPLANDING_WEBINAR_USERS_NAME'),
							'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_STARTUPLANDING_WEBINAR_USERS_NAME_DESC'),
							'std'=>'John Doe'
						),
						'avatar'=>array(
							'type'=>'media',
							'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_STARTUPLANDING_WEBINAR_USERS_AVATAR'),
							'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_STARTUPLANDING_WEBINAR_USERS_AVATAR_DESC'),
							'std'=>''
						),
					),
				),
				'duration'=>array(
					'type'=>'text',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_STARTUPLANDING_WEBINAR_DURATION'),
					'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_STARTUPLANDING_WEBINAR_DURATION_DESC'),
					'std'=>'58min'
				),
				'alignment'=>array(
					'type'=>'select',
