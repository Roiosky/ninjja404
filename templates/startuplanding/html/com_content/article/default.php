...
<div class="article-details <?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
    ...
    <div class="article-details-wrap">
        ...
        <?php if ($info == 1 || $info == 2) : ?>
            <?php if ($useDefList) : ?>
                <?php echo LayoutHelper::render('joomla.content.info_block', array('item' => $this->item, 'params' => $params, 'position' => 'below', 'item_type' => 'details')); ?>
            <?php endif; ?>
        <?php endif; ?>
    ...
    <?php if ($params->get('access-view')) : ?>
        ...
        <div class="sppb-row">
            <div class="col-md-8">
                <?php
                if (($tmpl_params->get('social_share') || $params->get('show_vote')) && !$this->print || ($params->get('show_author') && !empty($this->item->author))) : ?>
                    <div class="article-ratings-social-share d-flex justify-content-between">
                        <?php if ($params->get('show_author') && !empty($this->item->author)) : ?>
                            <div class="mr-auto align-self-center">
                                ...
                                ?>
                                <?php echo LayoutHelper::render('joomla.content.info_block.author', array('item' => $this->item, 'articleView' => 'details')); ?>
                            </div>
                        <?php endif; ?>
            ...
            <div class="col-md-4 blog-details-right">
                <!-- top right position -->
                <?php if ($doc->countModules('blogdetails-right-mod')) {
                    jimport('joomla.application.module.helper');
                    $modules = ModuleHelper::getModules('blogdetails-right-mod');
                    $modules_attribs['style'] = 'sp_xhtml';

                    foreach ($modules as $key => $module) {
                        echo ModuleHelper::renderModule($module, $modules_attribs);
                    }
                } ?>
...
<?php if ($tmpl_params->get('related_article') && count($relatedArticles) > 0) : ?>
    <?php
    echo LayoutHelper::render('joomla.content.related_articles', [
